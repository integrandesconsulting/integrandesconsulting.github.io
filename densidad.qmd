...
---
<div class="breadcrumbs"> <span>Portafolio</span> <span class="sep">></span> <span>Visualización espacial 3D de la densidad poblacional en el Perú</span> <span class="sep">></span> </div>
  ...
  <div class="accordion-item">
    <h2 class="accordion-header" id="hFeedback">
      <button class="accordion-button collapsed" type="button"
        ...
        Feedback sobre la iniciativa y la base de datos
      </button>
    </h2>
...
<div class="densidad-callout">
  <div class="densidad-callout-text">
    Si deseas imagénes con mayor resolución (&gt;50&nbsp;MB)
